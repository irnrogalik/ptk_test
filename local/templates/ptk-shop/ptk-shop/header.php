...
<!--                <div class="top_caret__wrap">
                    <a href="#" class="top_caret__link">
                        <span class="top_caret__ico ">
                            <?// include("img/n_img/n_application.svg"); ?>
                            <span class="top_caret__icoNum js_top_basket_aim n_invisible">0</span> доабвлять этому элементу класс n_invisible, если корзина пустая  
                        </span>
