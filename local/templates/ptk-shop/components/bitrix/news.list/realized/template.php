<div class="services wrap clearfix">
			...
			<div class="right flr">
				<div class="clearfix mgb">
					...
					<p class="quot">Огнезащитные материалы прошли испытания на  испытательно-исследовательском полигоне научно-исследовательского института ПБ И ЧС МЧС РБ и имеют действующие разрешительные документы.</p>
				</div>
				<div class="clearfix">
					<?
					$arItem = $arResult["ITEMS"][$i++];
